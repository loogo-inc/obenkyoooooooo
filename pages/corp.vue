  ...
  <div>
      ...
      <div class="container">
        <div class="row">
          <div class="col span-12 header">
            <h1><a href="/">勉強会（開発中）</a></h1>
            <div class="header-box">
              <a href=""><span class="contact-button">お問い合わせ</span></a>
            </div>
          </div>
        </div>
        <div class="row">
    ...
    <main>
      <div class="catch">
        ...
        <p>
          ここにキャッチコピーが入ります。<br />お店の宣伝やコンセプトなど。魅せる文言を入力。
        </p>
      </div>
              ...
              <form method="post" action="">
                <table class="table full-width">
                  <tbody>
                    ...
                    <tr>
                      <th>
                        <label for="exampleMessage">お問い合わせ内容</label>
                      </th>
                      <td>
                        <textarea
    ...
    <div class="copyright">
      <a href="https://popo-design.net" target="_blank"
        >Copyright © popodesign.</a
      >
    </div>
